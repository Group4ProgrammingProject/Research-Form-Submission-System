...
def email_registration_form(request, form_class=RegistrationForm):
    ...
    if form.is_valid():
        ...
        return render(request, 'templates/email_registration_sent.html', {
            'email': email,
        })

    return render(request, 'templates/email_registration_form.html', {
        'form': form,
    })
...
def email_registration_confirm(request, code, max_age=3 * 86400):
    ...
    return render(request, 'templates/password_set_form.html', {
        'form': form,
        })
